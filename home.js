  ...
  function getCurrAddress() {
    ...
    var postURL = `https://sandbox.estated.com/v4/property?token=OA4xkl5AK3wzqzoSb7M1wZWTcIriv9&street_address=${street_address}&city=${city}&state=${state}&zip_code=${zip_code}`;
