  ...
  function getCurrAddress() {
    ...
    var postURL = `https://sandbox.estated.com/v4/property?token=wJfCcOLbvu8tXyNh5SzR85DX37xeJv&street_address=${street_address}&city=${city}&state=${state}&zip_code=${zip_code}`;
